...
trait Update
{
     ...
     * @return UpdateObject
     */
    public function getWebhookUpdates($shouldEmitEvent = true,$request): UpdateObject
    {
        return $this->getWebhookUpdate($shouldEmitEvent,$request);
    }
     ...
     * @return UpdateObject
     */
    public function getWebhookUpdate($shouldEmitEvent = true,$request): UpdateObject
    {
